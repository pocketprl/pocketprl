...
`2.5.0 = 15`, `2.5.1 = 16`, `2.5.2 = 17`, `2.5.3 = 18`). It governs the **R and B** codes only; the P code is an
independent counter that moves on its own (2.4.0 went out as `100013`, 2.4.1 as
`100027`, 2.5.0 as `100041`, 2.5.1 as `100042`, 2.5.2 as `100043`, 2.5.3 as `100044`). Every code is fixed when its build
is published and never rebuilt.

Examples: `2.5.3` is `P 100044`, `R 249982`, `B 300018`; `2.5.2` is `P 100043`,
