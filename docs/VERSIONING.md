...
| Lane | Code | Role |
|---|---|---|
| **P** primary | monotonic counter in `gradle.properties` (currently `100046`) | Fresh installs and normal updates land here. Bumped for every published primary build, never reused. |
...
`2.5.0 = 15`, `2.5.1 = 16`, `2.5.2 = 17`, `2.5.3 = 18`, `2.5.4 = 19`, `2.5.5 = 20`). It governs the **R and B** codes only; the P code is an
...
2.5.4 as `100045`, 2.5.5 as `100046`). Every code is fixed when its build is published and never rebuilt.

Examples: `2.5.5` is `P 100046`, `R 249980`, `B 300020`; `2.5.4` is `P 100045`,
