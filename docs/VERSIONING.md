...
| Lane | Code | Role |
|---|---|---|
| **P** primary | monotonic counter in `gradle.properties` (currently `100049`) | Fresh installs and normal updates land here. Bumped for every published primary build, never reused. |
...
`2.5.0 = 15`, `2.5.1 = 16`, `2.5.2 = 17`, `2.5.3 = 18`, `2.5.4 = 19`, `2.5.5 = 20`, `2.5.6 = 21`, `2.6.0 = 22`, `2.6.1 = 23`). It governs the **R and B** codes only; the P code is an
...
2.5.4 as `100045`, 2.5.5 as `100046`, 2.5.6 as `100047`, 2.6.0 as `100048`,
2.6.1 as `100049`). Every code is fixed when its build is published and never rebuilt.

Examples: `2.6.1` is `P 100049`, `R 249977`, `B 300023`; `2.6.0` is `P 100048`,
`R 249978`, `B 300022`; `2.5.6` is `P 100047`,
...
`R 249983`, `B 300017`; `2.5.1` is `P 100042`,
`R 249984`, `B 300016`; `2.5.0` is `P 100041`,
